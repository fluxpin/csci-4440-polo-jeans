###
Class: GameState
Contains the set of active GameObjects and functions to step through their actions and draw them.
###
class GameState
...
#step through a single action for all the game objects active in this gamestate.
step: ->
